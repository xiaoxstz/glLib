...
from glLibObjects import glLibDrawScreenQuad, glLibGrid2D
...
##        print self.draw_shader.errors
        ...
        self.point_texture = glLibTexture2D("glLib/fireparticle.png",(0,0,8,8),GLLIB_RGBA)
    ...
    def draw(self):
        ...
        self.draw_shader.pass_vec3("scale",list(map(lambda x:2.0*x,self.scale)))
