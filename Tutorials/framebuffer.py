...
##    shadowmapsize = 1024
    shadowmapsize = 2048
##    shadowmapsize = 4096
    LightView = glLibView3D((0,0,shadowmapsize,shadowmapsize),15,5,15)
...
def Draw(Window):
    ...
    depthmap,proj,view = glLibMakeDepthMapFBO(fbo,Light1,LightView,SpaceshipPosition,DrawOccluders,offset=2.0)
    ...
    glPushMatrix()
    glLibUseDepthMaps([[depthmap,proj,view]],1,2,Shader,TransformOccluders)
    DrawOccluders()
    glPopMatrix()
