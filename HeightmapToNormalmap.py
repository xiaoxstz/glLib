...
surface = ChooseFile()
setting_alpha = raw_input("Set height as alpha channel?  ")
if setting_alpha in ["0","False",""]: setting_alpha = False
else: setting_alpha = True
size = surface.get_size()
surface2 = pygame.Surface(size) #greyscale
surface3 = pygame.Surface([size[0]-1,size[1]-1]) #normal map
if setting_alpha:
    pygame.display.set_mode((1,1))
    surface3 = surface3.convert_alpha()
    pygame.display.quit()
